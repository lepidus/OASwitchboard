...
class OASwitchboardAPIClientTest extends PKPTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sandboxWasConfigured = array_key_exists('sandbox', isset($configurationData['oaswitchboard']) ? $configurationData['oaswitchboard'] : []);
        $this->originalSandboxConfiguration = isset($configurationData['oaswitchboard']['sandbox']) ? $configurationData['oaswitchboard']['sandbox'] : null;
    ...
    public function sandboxConfigurationProvider(): array
    {
        return [
