describe('Bad Request Error when submission is published', function () {
    it('Access submission', function () {
        ...
        cy.get('.app__notifications').contains("It seems we don't have the mandatory data for sending the P1-PIO message, please check the submission activity log to understand the pending requirements.");
        cy.get('.app__notifications').contains("The first author of the article must have a ROR associated to its affiliation.");
